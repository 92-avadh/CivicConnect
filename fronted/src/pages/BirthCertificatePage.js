        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-xl mx-auto bg-white p-8 rounded-lg shadow-sm border">
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    <input name="childsFullName" value={formData.childsFullName} onChange={handleChange} placeholder="Child's Full Name" required className="mt-1 w-full px-3 py-2 border rounded-md" />
                    <div>
                        <input 
                            name="dateOfBirth" 
                            type="date" 
                    ...
                    <input name="hospitalOfBirth" value={formData.hospitalOfBirth} onChange={handleChange} placeholder="Hospital of Birth" required className="mt-1 w-full px-3 py-2 border rounded-md" />
                    <input name="mothersFullName" value={formData.mothersFullName} onChange={handleChange} placeholder="Mother's Full Name" required className="mt-1 w-full px-3 py-2 border rounded-md" />
