...
export const ProfilePage = () => {
    // Get the currentUser directly from the context
    const { user: currentUser } = useContext(AuthContext);

    // If the user isn't loaded yet or is logged out, show a message
    if (!currentUser) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                {/* The "My Reported Issues" section has been completely removed. */}
