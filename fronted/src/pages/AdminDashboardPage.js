    ...
    return (
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Death Certificate Applications - Added this section to fix the unused variable warning */}
                <div className="mb-12">
                    ...
                    <div className="bg-white shadow-sm rounded-lg overflow-x-auto">
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">App No.</th>
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Deceased's Name</th>
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Date of Death</th>
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Father's Name</th>
                                </tr>
                            </thead>
                            <tbody className="bg-white divide-y divide-gray-200">
                                {deathApplications.map(app => (
                                    <tr key={app.applicationNumber}>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{app.applicationNumber}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{app.deceasedsName}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{app.dateOfDeath}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{app.fathersName}</td>
                                    </tr>
                                ))}
                            </tbody>
                ...
                {/* Water Connection Applications - Added this section to fix the unused variable warning */}
                <div className="mb-12">
                    ...
                    <div className="bg-white shadow-sm rounded-lg overflow-x-auto">
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {waterApplications.map(app => (
                                    <tr key={app.applicationNumber}>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{app.applicationNumber}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{app.applicantsName}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{app.address}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
