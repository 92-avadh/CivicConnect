...
export const RegisterPage = ({ selectedUserType, formData, handleInputChange, handleRegister, handleTabChange, phoneError, passwordError, handleGoogleSignUp }) => {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 sm:p-8">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                    <label htmlFor="terms" className="font-medium text-gray-700">I agree to the <button type="button" onClick={() => handleTabChange('privacy')} className="text-blue-600 hover:text-blue-800 underline bg-transparent border-none p-0 font-medium cursor-pointer">Terms and Conditions</button></label>
                </div>
            </div>
          ...
          <button 
            ...
            className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-gray-700 font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
          ...
          <p className="text-center text-sm text-gray-600 mt-6">Already have an account? <button type="button" onClick={() => handleTabChange('login')} className="text-blue-600 hover:text-blue-800 font-semibold bg-transparent border-none p-0 underline cursor-pointer">Login here</button></p>
        </div>
      </div>
    );
};